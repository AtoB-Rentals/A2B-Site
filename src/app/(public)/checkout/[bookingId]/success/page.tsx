...
const Success = async ({ params }: {
    ...
    if (booking === null || booking === "Not Authorized") {
        return (
            <main className="pb-28">
                <div 
                    className="flex flex-col gap-3 h-[70vh] justify-center items-center"
                >
                    <h1
                        className="text-xl"
                    >
    ...
    const startTimef = DateTime
        .fromISO(booking.startTime.utc)
        .toLocal()
        .toFormat('LLL d, yyyy t')

    const endTimef = DateTime
        .fromISO(booking.endTime.utc)
        .toLocal()
        .toFormat('LLL d, yyyy t')
            ...
            <section className="rounded-md shadow-[0px_0px_4px_1px] shadow-success pt-2 pb-6">
                ...
                <section className="flex flex-col gap-4 rounded-md py-4 p-2 text-center max-w-[600px] mb-4 mx-3 md:mx-auto bg-base-200 shadow-base-300 shadow-[inset_0px_4px_8px]">
                    ...
                    <div className="flex flex-col md:flex-row items-center md:justify-between">
                        ...
                        <Link
                            href={`https://www.google.com/maps?q=${encodeURIComponent(booking.pickupAddress.formatted)}`} 
                            target="_blank" 
                    ...
                    <div className="flex flex-col md:flex-row items-center md:justify-between">
                        ...
                        <Link
                            href={`https://www.google.com/maps?q=${encodeURIComponent(booking.dropOffAddress.formatted)}`} 
                            target="_blank" 
                            rel="noopener noreferrer" 
                            className="link link-primary truncate max-w-xs md:max-w-sm overflow-hidden whitespace-nowrap"
                        >
                    ...
                    <div className="flex flex-col md:flex-row items-center py-1 md:justify-between">
                        ...
                        <p className="font-bold text-success text-lg">${numToDallor(booking.totalPrice)}</p>
                    </div>
                </section>
                <section className="flex flex-col gap-4 rounded-md py-4 p-2 max-w-[600px] mb-4 mx-3 md:mx-auto bg-[#E9F4EC] shadow-base-300 shadow-[inset_0px_4px_8px] text-black">
                    ...
                    <ul className="list-disc pl-5">
                        ...
                        <li>Please bring your driver's license and credit card used for booking</li>
                        <li>Contact our 24/7 support if you need any assistance - <Link 
